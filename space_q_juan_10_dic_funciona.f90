...
!! Calculate the two body contributions
      ...
      End If
         ...
         tei_spatial_proc=zzero    
            ...
            !!PARALLELIZE HERE
!$OMP PARALLEL PRIVATE(kdicp_radial,ij,il,ik,i_spatial,ang1,iy,l1,m1,l2,m2,kdicp_ang,l3,m3,ldicp_ang,l4,m4,ll,twoe_fedvr_angle,n1,n1_kdicp_radial)! Before ii (runing in angular)
!!PRIVATE(kdicp_radial,ij,il,ik,i_spatial,ang1,iy,l1,m1,l2,m2,kdicp_ang,l3,m3,ldicp_ang,l4,m4,ll,twoe_fedvr_angle,ii) Before n1
!!PRIVATE(kdicp_radial,ij,il,ik,i_spatial) !! if it is in the angular part            
            !$OMP DO           
            
         Do ii=1,size(twoe_ang1(:))

!            print*,ii
!            print*, ii,size(twoe_ang1(:))
...
!!$                        Do ll=max(abs(l1-l2), abs(l3-l4)), min((l1+l2), (l3+l4))
            twoe_fedvr_angle=twoe_angle_index_integral(ii)!fedvr3dbase_angpart(ll,l1,m1,l2,m2,l3,m3,l4,m4)!twoe_angle_store(ang1,iy,kdicp_ang,ldicp_ang,ll)
...
!!$               Do kdicp_radial=1,fedvr3d%nb_r !! Running in the radial grid for the second coordinate, r2 
                  ...
                  Do n1_kdicp_radial= 1, fedvr3d%nb_r*fedvr3d%nb_r

                     n1=mod(n1_kdicp_radial,fedvr3d%nb_r) !! Radial node corresponding to r1
                     kdicp_radial=(n1_kdicp_radial-n1)/fedvr3d%nb_r+1 !! Radial node corresponding to r2
                     If (n1.eq.0) n1=fedvr3d%nb_r
...
!!$                        ix=(ang1-1)*fedvr3d%nb_r+n1                             
                  ...
                  if (abs(twoe_radial_store(n1,kdicp_radial,ll)).lt.1d-15) cycle !JUAN: 8 dic
