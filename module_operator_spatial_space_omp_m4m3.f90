...
!! this subroutine has a prescription to run only for the states which fulfill
!! m4-m3=m1-m2
...
Do m4m3_counter=1,ang_m4m3%total(m1-m2)

   kdicp_ang=ang_m4m3%ang3(m1-m2,m4m3_counter)
   ldicp_ang=ang_m4m3%ang4(m1-m2,m4m3_counter)

      If (phi1.le.system%np0+system%np1.and.kdicp_ang.gt.ang_max_core) cycle
      If (phi2.le.system%np0+system%np1.and.ldicp_ang.gt.ang_max_core) cycle
      ...
      Do kdicp_radial=1,fedvr3d%nb_r
         
         n3=kdicp_radial  
         kdicp=(kdicp_ang-1)*fedvr3d%nb_r+n3
